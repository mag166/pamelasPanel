class StudentCohortsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @student_cohort.save
        format.html { redirect_to @student_cohort.cohort, notice: 'Student was successfully added to Cohort.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to @student_cohort.cohort, notice: 'Student cohort was successfully destroyed.' }
