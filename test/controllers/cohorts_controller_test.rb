...
class CohortsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cohort" do
    assert_difference('Cohort.count') do
      post cohorts_url, params: { cohort: { course_id: @cohort.course_id, end_date: @cohort.end_date, name: @cohort.name, start_date: @cohort.start_date, teacher_id: @cohort.teacher_id } }
    end
  ...
  test "should update cohort" do
    patch cohort_url(@cohort), params: { cohort: { course_id: @cohort.course_id, end_date: @cohort.end_date, name: @cohort.name, start_date: @cohort.start_date, teacher_id: @cohort.teacher_id } }
